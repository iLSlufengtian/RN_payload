    ...
    fetch: function (conf: RequestConf, onSuccess, onFailure) {
        ...
        if (method === 'POST' || method === 'PUT') {
            ...
            if (conf.trueUrl) {
                ...
                if (conf.urlParams) {
                    url = UrlHelper.postUrlWithParamsMiddle(conf.url, conf.params).url;
                    conf.params=UrlHelper.postUrlWithParamsMiddle(conf.url, conf.params).params
                } else {
            ...
            if (conf.params) {
                if (conf.urlParams) {
                    url = UrlHelper.getUrlWithParamsMiddle(conf.url, conf.params)
                } else {
